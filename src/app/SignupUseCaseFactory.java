...
public class SignupUseCaseFactory {
    ...
    public static SignupView create(
        ...
        try {
            ...
            ClearController clearController = createClearUserCase(viewManagerModel, clearViewModel, clearUserDataAccessObject);
    ...
    private static ClearController createClearUserCase(ViewManagerModel viewManagerModel, ClearViewModel clearViewModel, ClearUserDataAccessInterface clearUserDataAccessObject) throws IOException{
